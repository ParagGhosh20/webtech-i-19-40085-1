...
{
$birthErr ="Input Year must be between 1900 to 2021";
$flag=0;
}
else {
...
{
$confirmpasswordErr = "Password and confirm password need to be same";
$flag=0;
}
}
}
...
header("location:../view/signupUserView.php?" .
...
$data['gender']=$gender;
 ...
 if (addSignupInfo($data)) {
  echo "<script>alert('Successfully Added');
               window.location.href = '../view/signupUserView.php';
          </script>";
}
