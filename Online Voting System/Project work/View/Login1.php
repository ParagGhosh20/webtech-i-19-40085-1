...
<div class="container">
		...
		<form action="Login1_data.php" method="post">
			<div class="form">
			...
			<input type="password" name="password" id="pwd" placeholder="Enter the password">
...
if (isset($_POST['name'])) {
	if ($_POST['name']==$username && $_POST['pass']==$password) {
		...
		echo "<script>alert('name or pass incorrect!')</script>";
	}
